...
sub _getDefaultConfig {
    ...
    $$cfg{'treeConnections'}{'Alt+j'}  = ['Connections Tree',  'left',                'left'];
    $$cfg{'treeConnections'}{'Alt+l'}  = ['Connections Tree',  'right',               'right'];
    $$cfg{'treeConnections'}{'Alt+i'}  = ['Connections Tree',  'up',                  'up'];
    $$cfg{'treeConnections'}{'Alt+k'}  = ['Connections Tree',  'down',                'down'];
    $$cfg{'treeConnections'}{'Alt+a'}  = ['Connections Tree',  'previous',            'Previous Connection List'];
    $$cfg{'treeConnections'}{'Alt+s'}  = ['Connections Tree',  'next',                'Next Connection List'];
